...
const FAQ: React.FC<FAQProps> = ({ items = DEFAULT_FAQ_ITEMS, title = "Technical Queries" }) => {
  return (
    <section id="faq" className="py-24 border-t border-white/5 bg-brand-dark">
        <div className="container mx-auto px-6 max-w-4xl">
            <h2 className="font-display text-4xl font-bold mb-12 text-center text-white">{title}</h2>
