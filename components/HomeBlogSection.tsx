...
import { ArrowRight, Calendar, Clock, BrainCircuit } from 'lucide-react';
    ...
    <section className="py-24 bg-[#050505] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
          <div>
            <div className="inline-flex items-center gap-2 text-tdc-cyan font-mono text-sm tracking-widest mb-4 uppercase">
          ...
          <Link 
            to="/blog" 
            className="flex items-center gap-2 text-tdc-cyan border-b border-tdc-cyan pb-1 hover:opacity-80 transition-opacity font-mono text-sm uppercase tracking-wider group"
          >
