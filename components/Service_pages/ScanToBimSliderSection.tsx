...
export const ScanToBimSliderSection: React.FC = () => {
  return (
          ...
          <div className="lg:w-1/2">
            ...
            >
              <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
                Don't Prefabricate on a <span className="text-blue-400">Guess.</span>
              </h2>
              ...
              <div className="mt-8 p-6 bg-slate-900 rounded-lg border-l-4 border-blue-500">
